...
impl RepoClient {
    async fn load_changeset_base(
        ...
        let reference_response: GitReferenceResponse = self
            .client
            .get(format!("{}/repos/{}/{}/git/ref/heads/{}", GITHUB_API_BASE, owner, repo, branch))
            ...
            match operation.operation_type.as_str() {
                "upsert" => {
                    let blob_response: CreateBlobResponse = self
                        .client
                        .post(format!("{}/repos/{}/{}/git/blobs", GITHUB_API_BASE, owner, repo))
                        .headers(self.build_headers())
    ...
    async fn create_changeset_commit(
        ...
        let created_tree: CreateTreeResponse = self
            .client
            .post(format!("{}/repos/{}/{}/git/trees", GITHUB_API_BASE, owner, repo))
            .headers(self.build_headers())
        ...
        self.client
            .post(format!("{}/repos/{}/{}/git/commits", GITHUB_API_BASE, owner, repo))
            .headers(self.build_headers())
    ...
    async fn update_branch_reference(
        ...
        self.client
            .patch(format!("{}/repos/{}/{}/git/refs/heads/{}", GITHUB_API_BASE, owner, repo, branch))
            .headers(self.build_headers())
    ...
    pub async fn commit_changeset(
        ...
        let CreatedChangesetTree {
            updated_files,
            tree_items,
        } = self.create_changeset_tree_items(owner, repo, operations).await?;
