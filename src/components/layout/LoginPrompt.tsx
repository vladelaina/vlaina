  ...
  return (
    <div className="p-2 pb-0">
      <button
        ...
        className="group inline-flex h-10 w-full cursor-pointer items-center justify-center gap-2 rounded-full border border-black/5 bg-[var(--neko-bg-primary)] px-4 text-[13px] font-medium text-[var(--neko-text-primary)] shadow-[0_10px_24px_rgba(15,23,42,0.08)] transition-[border-color] duration-150 hover:border-black/8 active:scale-[0.985] dark:border-white/5 dark:shadow-[0_12px_24px_rgba(0,0,0,0.22)] dark:hover:border-white/10"
      >
