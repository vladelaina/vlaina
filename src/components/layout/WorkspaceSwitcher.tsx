  ...
  return (
    <Popover.Root open={isOpen} onOpenChange={setIsOpen}>
      <Popover.Trigger asChild>
        <button
          className={cn(
            'group flex h-8 items-center gap-1.5 rounded-md px-1.5 py-1 text-[var(--neko-text-primary)] outline-none transition-colors select-none hover:bg-[var(--neko-hover)]',
