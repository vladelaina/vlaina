export interface NotesSidebarMenuPosition {
  top: number;
  left: number;
}
...
export const SIDEBAR_SCROLL_ROOT_SELECTOR = '[data-notes-sidebar-scroll-root="true"]';
export const MENU_LAYER_SELECTOR = '[data-notes-sidebar-context-menu-layer="true"]';
