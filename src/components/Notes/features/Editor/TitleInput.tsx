...
export function TitleInput({ notePath, initialTitle }: TitleInputProps) {
  ...
  return (
    <input
      ...
      className="w-full bg-transparent border-none outline-none text-[28px] font-bold leading-[calc(1em+8px)] tracking-[-0.02em] text-[var(--neko-text-primary)] placeholder:text-[var(--neko-text-disabled)] selection:bg-[#2783de] selection:text-white"
