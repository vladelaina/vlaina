import type { LanguageDetectionContext } from '../types';

export function shouldRejectBeforeJavaScriptSignals(ctx: LanguageDetectionContext): boolean {
...
export function shouldRejectAfterJavaScriptSignals(ctx: LanguageDetectionContext): boolean {
