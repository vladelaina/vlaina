...
export function DiagnosticsPanel() {
  ...
  return (
    <div
      ...
      className={cn(
        'pointer-events-none fixed right-[var(--vlaina-size-16px)] top-[var(--vlaina-size-56px)] z-[var(--vlaina-z-max)] flex max-w-[var(--vlaina-width-diagnostics-max)] items-center gap-1.5 rounded-full border border-[var(--vlaina-color-subtle-border)] bg-[var(--vlaina-color-setting-panel)] px-2 py-1.5 text-[var(--vlaina-font-xs)] text-[var(--vlaina-sidebar-notes-text)] shadow-[var(--vlaina-shadow-lg)]',
      )}
    >
      <span
