        ...
        <div className="space-y-4">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="space-y-2">
              <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">{t('settings.ai.managedTitle')}</h3>
              <p className="text-xs text-gray-500">
                {t('settings.ai.managedDescription')}
              </p>
              <p className="text-xs text-gray-500">{t('settings.ai.baseUrl', { url: MANAGED_API_BASE })}</p>
            </div>
            <div className="flex items-center gap-2">
              {isConnected ? (
                ...
                <div className="text-xs text-gray-500">{t('settings.ai.chooseProvider')}</div>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-white/[0.02] p-4">
              <div className="text-[11px] font-semibold uppercase tracking-[0.16em] text-gray-500">{t('settings.ai.status')}</div>
            ...
            <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-white/[0.02] p-4 md:col-span-2">
              <div className="text-[11px] font-semibold uppercase tracking-[0.16em] text-gray-500">{t('settings.ai.account')}</div>
              <div className="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">
