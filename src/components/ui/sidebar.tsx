...
const SIDEBAR_WIDTH = themeSidebarTokens.width
const SIDEBAR_WIDTH_MOBILE = themeSidebarTokens.mobileWidth
const SIDEBAR_WIDTH_ICON = themeSidebarTokens.iconWidth
  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          "relative w-(--sidebar-width) bg-transparent transition-[width] duration-[var(--vlaina-duration-200)] ease-linear",
          "group-data-[collapsible=offcanvas]:w-0",
          "group-data-[side=right]:rotate-180",
          variant === "floating" || variant === "inset"
            ? "group-data-[collapsible=icon]:w-[var(--vlaina-width-sidebar-floating-icon-gap)]"
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-[var(--vlaina-z-10)] hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-[var(--vlaina-duration-200)] ease-linear md:flex",
          side === "left"
            ? "left-0 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)]"
            : "right-0 group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)]",
          variant === "floating" || variant === "inset"
            ? "p-2 group-data-[collapsible=icon]:w-[var(--vlaina-width-sidebar-floating-icon-container)]"
      ...
      >
        <div
          ...
          className="bg-[var(--sidebar)] group-data-[variant=floating]:border-[var(--sidebar-border)] flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-[var(--vlaina-shadow-sm)]"
        >
          {children}
        </div>
      </div>
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-[var(--vlaina-shadow-sm)] md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2",
        className
      )}
      {...props}
    />
...
function SidebarInput({
  ...
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn("bg-[var(--background)] h-8 w-full shadow-[var(--vlaina-shadow-none)]", className)}
      {...props}
    />
  )
}
