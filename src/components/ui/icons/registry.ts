...
export const icons: Record<string, IconSource> = {
  ...
  'common.redo': ArrowUturnRightIcon,
  ...
  'chat.branch': GitPullRequestCreate,
  ...
  'whiteboard.select': MousePointer2,
  'whiteboard.hand': Hand,
  'whiteboard.pen': PenTool,
  'whiteboard.pencil': Pencil,
  'whiteboard.marker': Highlighter,
  'whiteboard.fountain': PenLine,
  'whiteboard.watercolor': Brush,
  'whiteboard.crayon': Pencil,
  'whiteboard.eraser': Eraser,
  'whiteboard.ruler': Ruler,
  'whiteboard.note': StickyNote,
  'whiteboard.rect': Square,
  'whiteboard.ellipse': Circle,
  'whiteboard.image': PhotoIcon,
  'whiteboard.connector': Waypoints,
  'media.play': PlayIcon,
