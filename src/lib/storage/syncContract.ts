...
export const SYNC_CONTRACTS: readonly SyncContractEntry[] = [
  ...
  },
  {
    ...
    storageKeys: [],
    crossWindow: false,
    notes: 'Each notes root has versioned board documents under the system userData directory; writes are ordered per board and open windows do not live-merge edits.',
  },
  {
    id: 'notesRoot.recent',
    owner: 'notesRoot',
