...
* **Brand Neutrality:** Never reference external brands, products, or competitors in comments. Describe the behavior instead.
...
## UI & Visual Standards
**Iconography: UNIFIED 20px Standard**
* **Mandatory Size:** All functional and decorative icons MUST be sized at exactly **20px**.
* **Implementation:** 
